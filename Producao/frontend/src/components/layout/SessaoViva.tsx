...
export function SessaoViva() {
  ...
  return (
    <div
      role="status"
      className="sem-imprimir fixed bottom-6 left-1/2 z-50 flex w-[min(30rem,92vw)] -translate-x-1/2 items-start gap-3 rounded-2xl border border-[var(--color-aviso)]/40 bg-superficie px-4 py-3 shadow-forte"
    >
